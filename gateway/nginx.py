...
def render(config, generation, cache_dir="/cache", run_dir="/run/gateway", port=80,
    ...
    lines = [
        "# Generated by Gateway. Edit through the admin panel.",
        ...
        "    log_format gateway '$remote_addr [$time_local] $host '",
    ...
    lines += ["    limit_conn_zone $binary_remote_addr zone=global_conn:10m;",
              ...
              f'    proxy_cache_path "{cache_dir}" levels=1:2 keys_zone=gateway_cache:16m '
        ...
        for route in host["routes"]:
            ...
            for location in locations:
                ...
                if route["cache"]:
                    ...
                    lines += ["            proxy_cache gateway_cache;",
