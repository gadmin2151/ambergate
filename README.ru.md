...
<p align="center"><a href="#быстрый-старт">Быстрый старт</a> · <a href="#что-умеет">Возможности</a> · <a href="#карта-сервисов">Карта сервисов</a> · <a href="#удалённые-docker-машины">Агенты</a> · <a href="#переписывание-ответов">Переписывание ответов</a> · <a href="#документация">Документация</a></p>
