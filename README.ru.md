...
В разделе **Агенты → Добавить агента** создайте уникальный токен и скачайте готовый Compose. В панели доступны статус через SSE, список контейнеров, отключение агента и замена токена. HTTPS обслуживает ваш существующий внешний TLS-прокси.
